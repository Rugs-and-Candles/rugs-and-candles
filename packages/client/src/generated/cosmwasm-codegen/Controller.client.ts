...
import { ControllerQueryMsgBuilder, ControllerExecuteMsgBuilder } from "./Controller.message-builder";
export interface IControllerAppQueryClient {
  moduleId: string;
  ...
  connectSigningClient: (signingClient: SigningCosmWasmClient, address: string) => ControllerAppClient;
  getAddress: () => Promise<string>;
}
export class ControllerAppQueryClient implements IControllerAppQueryClient {
  accountQueryClient: AbstractAccountQueryClient;
  moduleId: string;
  _moduleAddress: string | undefined;
  ...
  status = async (params: CamelCasedProperties<Extract<QueryMsg, {
    ...
    return this._query(ControllerQueryMsgBuilder.status(params));
  };
  config = async (): Promise<ConfigResponse> => {
    return this._query(ControllerQueryMsgBuilder.config());
  };
  userPosition = async (params: CamelCasedProperties<Extract<QueryMsg, {
    user_position: unknown;
  }>["user_position"]>): Promise<UserPositionResponse> => {
    return this._query(ControllerQueryMsgBuilder.userPosition(params));
  };
  participants = async (): Promise<ParticipantsResponse> => {
    return this._query(ControllerQueryMsgBuilder.participants());
  };
  ...
  connectSigningClient = (signingClient: SigningCosmWasmClient, address: string): ControllerAppClient => {
    return new ControllerAppClient({
...
export interface IControllerAppClient extends IControllerAppQueryClient {
...
export class ControllerAppClient extends ControllerAppQueryClient implements IControllerAppClient {
  accountClient: AbstractAccountClient;
  ...
  setStatus = async (params: CamelCasedProperties<Extract<ExecuteMsg, {
    ...
    return this._execute(ControllerExecuteMsgBuilder.setStatus(params), fee, memo, _funds);
  };
  updateConfig = async (fee: number | StdFee | "auto" = "auto", memo?: string, _funds?: Coin[]): Promise<ExecuteResult> => {
    return this._execute(ControllerExecuteMsgBuilder.updateConfig(), fee, memo, _funds);
  };
  join = async (fee: number | StdFee | "auto" = "auto", memo?: string, _funds?: Coin[]): Promise<ExecuteResult> => {
    return this._execute(ControllerExecuteMsgBuilder.join(), fee, memo, _funds);
  };
  rollDice = async (fee: number | StdFee | "auto" = "auto", memo?: string, _funds?: Coin[]): Promise<ExecuteResult> => {
    return this._execute(ControllerExecuteMsgBuilder.rollDice(), fee, memo, _funds);
  };
